...
from test_generator_part2 import build_test_class_part2
...
if __name__ == '__main__':
    ...
    for filename in data_files:
        if filename.split('/')[-1] == 'sentences.csv' or filename.split('/')[-1] == 'reciprocal.csv':
            cls = build_test_class(filename)
        elif filename.split('/')[-1] == 'calculator.csv' or filename.split('/')[-1] == 'graph.csv':
            cls = build_test_class_part2(filename)
