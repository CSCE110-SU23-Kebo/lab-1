...
def filter_checkout(out):
    ...
    replace_arr = [
            ...
            'Book author\'s name: ',
            'How many days: ',
            "Remove all or an item? (Enter 'all' or 'book title'): ",
...
def filter_manage(out):
    if "Information not found!" in out:
        return out.splitlines()[-1]
    anchor_idx = handle_anchor_idx(out, '====')
